...
- [x] Replace "PROCESSING" with "IN-PROGRESS" in `docs/explanation/subtasks-hierarchy.md`
- [x] Replace "PROCESSING" with "IN-PROGRESS" in `docs/explanation/task-management.md`
- [x] Replace "PROCESSING" with "IN-PROGRESS" in `docs/explanation/README.md`
- [x] Replace "PROCESSING" with "IN-PROGRESS" in `docs/explanation/backend-system.md`
- [x] Replace "PROCESSING" with "IN-PROGRESS" in `docs/explanation/features-overview.md`
- [x] Replace "PROCESSING" with "IN-PROGRESS" in `docs/explanation/synchronization.md`
...
- This follows up on `roadmap/completed/007-dev-doc-status-abbreviation-inconsistency.md` which only fixed `docs/explanation/cli-interface.md`
