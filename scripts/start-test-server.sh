...
echo "Username:       \${NEXTCLOUD_ADMIN_USER:-admin}"
echo "Password:       (set via NEXTCLOUD_ADMIN_PASSWORD env var)"
echo ""
echo "CalDAV URL:     http://localhost:8080/remote.php/dav"
echo ""
echo "WARNING: This is a test server. Do NOT expose to external networks."
echo ""
echo "Commands:"
